...
const dataCR = makedata(127);

const dataCP = makedata(139);

const dataCDEX = makedata(151);
...
const chart2 = makeplot(dataCR);
const chart3 = makeplot(dataCP);
const chart4 = makeplot(makedata(151));
```
